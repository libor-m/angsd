...
double em1(double *sfs,Matrix<double> *GL1,double tole=0.01,int maxIter=10){
  double oldLik,lik;
  if(nThreads>1)
    oldLik = lik1_master();
  else
...
double em2(double *sfs,Matrix<double> *GL1,Matrix<double> *GL2,double tole=0.01,int maxIter=10){
  double oldLik,lik;
  if(nThreads>1)
    oldLik = lik2_master();
  else
